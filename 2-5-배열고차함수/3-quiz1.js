...
const filtered = traders.filter(transaction => transaction.year === 2022);

const traderIn2022=filtered.map(transaction => transaction.trader);
...
const traderInDeajeon = traders.filter(transac)
