...
//     console.log(food + ' 존마탱구리');
// }

foods.forEach((food, idx) => {
    console.log(`food: ${food} index: ${idx}`);
});
...
// filter() : 논리 조건에 맞는 데이터를 필터링 하여 새 배열로 리턴(즉, 원본 회손 XX)
...
/*
    filter => 10개의 데이터를 필터링하면 개수가  줄어듬
            ex) 10명의 회원 중 서울사는 사람들만 필터링 => 3명 남음
      map => 10개의 데이터를 매핑하면 개수가 그대로 10개
            ex) 10명의 회원 중 각 회원의 주소만 매핑
 */
